...
Xtrain_path = 'hf://datasets/vineeth32/machine-failure-prediction-data/Xtrain.csv'
Xtest_path = 'hf://datasets/vineeth32/machine-failure-prediction-data/Xtest.csv'
ytrain_path = 'hf://datasets/vineeth32/machine-failure-prediction-data/ytrain.csv'
ytest_path = 'hf://datasets/vineeth32/machine-failure-prediction-data/ytest.csv'
...
with mlflow.start_run():
  ...
  for i in range(len(results['params'])):
    ...
    with mlflow.start_run(nested=True):
      ...
      mlflow.log_metrics("mean_test_score", mean_score)
      mlflow.log_metrics("std_test_score", std_score)
